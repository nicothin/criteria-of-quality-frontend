...
### 7.1. Главное меню должно быть видимо при выключенном JS
...
### 7.2. Верстка имеет минимальные отличия в IE11 и последних 2-х версиях Chrome, Firefox, Opera и Safari
...
### 7.3. В именах классов нет транслита, использован английский язык


### 7.4. Использованные фреймворки для верстки (Bootstrap и подобные) установлены как зависимости проекта
